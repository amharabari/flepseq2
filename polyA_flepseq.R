...
weighted <- ggplot() +
  ...
  geom_area(data = weighted_data_smooth, aes(x = x, y = y, fill = Genotype), alpha = 0.3, position = "identity") +  
...
# Save Final Output
ggsave(filename = "flepseq2/pdf_xrn4_dne1_C50_distri.pdf", weighted, width = 8, height = 5, dpi = 1200)
